...
inline void AbslStringify(Sink& sink, ReductionKind reduction_kind) {
  switch (reduction_kind) {
    case ReductionKind::SUM:
      return sink.Append("sum");
    case ReductionKind::PRODUCT:
      return sink.Append("product");
    case ReductionKind::MIN:
      return sink.Append("min");
    case ReductionKind::MAX:
      return sink.Append("max");
  }
}
