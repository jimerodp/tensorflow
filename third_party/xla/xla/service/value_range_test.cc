...
TEST_F(ValueRangeTest, SelectValueWithCompareInConditional) {
  ...
  region1 {
    ...
    compare_const = s32[] constant(1030) // this valueis bigger than the max
    of add compare1 = pred[] compare(%add, compare_const), direction=LT
  ...
  region2 {
    ...
    compare_const = s32[] constant(5121) // this valueis bigger than the max
    of mult compare2 = pred[] compare(%mult, compare_const), direction=LT
